...
int S2[9][9] = {
    ...
    {3,7,1,4,6,2,5,8,9},
    {6,9,2,1,8,5,3,7,4},
    {4,5,8,7,9,1,6,1,3}, // <— CORRECTION : on modifie la solution incorrecte
    {8,3,6,9,2,4,1,5,7},
    {2,1,9,8,5,7,4,3,6},
    {7,4,5,3,1,6,2,9,8}
};
...
int S3[9][9] = {
    ...
    {1,9,7,8,3,4,5,6,2},
    {8,2,6,1,9,7,3,4,5},
    {3,7,4,6,8,2,9,1,0}, // <-- à corriger
    {9,5,1,4,0,3,6,2,8}, // <-- à corriger
    {5,1,9,3,2,6,8,7,4},
    {2,4,8,9,5,7,1,3,6},
    {7,6,3,8,1,8,2,5,9}
};
...
int S4[9][9] = {
    {9,1,7,3,4,5,2,6,8},
    {3,8,5,1,6,7,4,9,2},
    {6,4,2,8,9,0,5,3,1}, // <-- à corriger
    {1,7,8,5,6,3,9,4,0}, // <-- à corriger
    {2,9,4,9,8,1,6,5,3},
    {5,3,6,4,2,9,1,7,8},
    {4,2,9,9,3,0,8,1,6}, // <-- à corriger
    {8,6,3,7,1,4,9,2,5},
    {7,5,1,2,9,8,3,0,4}
};
